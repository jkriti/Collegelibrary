...
<div class="container-fluid form">
  ...
  color: white;
  font-size: 20px;">
                      <h2 class="text-center" style="color:white;">RETURN BOOK </b></h2>
                      ...
                      <li style=" margin: 10px;"><input type="textbox" name="s_id" required placeholder="Enter your Semester" class="form-control form2"></li>
                       ...
                       <div class="clear"></div>
                      <li style=" margin: 10px;"><input type="submit"  name="return_book"  value="Return Book" style="margin-top: 30px;
  width: 25%;
  height: 7%;
  background: green;
  text-align: center;
