...
<div class="clear"></div>
	...
	<div class="lib-button"><a href="viewBook.php">View All book</a></div>
	 <div class="lib-button"><a href="viewallbook.php">View Issued Book</a></div>
	<div class="lib-button"><a href="add.php">Add book</a></div>
	<div class="lib-button"><a href="issue.php">Issue Book</a></div>
	<div class="lib-button"><a href="return.php">Return Book</a></div>
	<div class="lib-button"><a href="viewAllStudents.php">View All Students</a></div>
	<div class="clear"></div> 
